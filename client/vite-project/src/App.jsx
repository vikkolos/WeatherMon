      ...
      try {
        const response = await axios.get(
          `https://wft-geo-db.p.rapidapi.com/v1/geo/cities?namePrefix=${searchValue}`,
          {
            headers: {
              "X-RapidAPI-Key":
                "0b07b22316mshbce3fcfd8d07384p19c366jsnd29201ce6597",
    ...
    <>
      <div className="min-h-screen w-full bg-white relative max-w-[1442px] mx-auto">
        ...
        <div className=" w-230 h-[65.3vh] bg-[#0100f2] absolute z-10 ml-50 mt-30 text-amber-50 text-6xl ">
          ...
          <div className="bg-white w-[30%] h-[25%] left-[64%] ml-3.5 absolute top-[68.8%] rounded-lg">
        ...
        <div className="w-lg h-15 absolute ml-102 z-11 bg-white border-black border-2 mt-22.5 rounded-lg text-black flex items-center justify-center ">
          <input
            ...
            className="w-full rounded-2xl p-1 m-3 px-4 focus:outline-none focus:ring-2 focus:ring-[#0100f2] transition duration-150 ease-in-out"
            value={searchValue}
        ...
        {places.length > 0 && (
          <div className="w-lg min-h-15 absolute ml-102 z-11 bg-white border-black border-2 mt-38 rounded-lg text-black flex items-center justify-center overflow-auto ">
